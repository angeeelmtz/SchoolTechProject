...
?>
    ...
    <head>
      ...
      <title>Admin - Agregar Usuario Staff</title>
      ...
      <div class="container mt-5">
        ...
        <form method="post" class="shadow p-3 mt-5 form-w" action="req/registrar-office-add.php">
          ...
          <div class="mb-3">
            ...
            <input type="radio" value="Male" checked name="gender"> Masculino
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" value="Female" name="gender"> Femenino
          </div>
          <div class="mb-3">
