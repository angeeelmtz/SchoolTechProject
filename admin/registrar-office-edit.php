...
?>
    ...
    <head>
      ...
      <title>Admin - Editar Staff</title>
    ...
    <body>
      ...
      <div class="container mt-5">
        <a href="registrar-office.php" class="btn btn-dark">Volver</a>

        <form method="post" class="shadow p-3 mt-5 form-w" action="req/registrar-office-edit.php">
          <h3>Editar Registro de Usuario Staff</h3>
          <hr>
          ...
          <div class="mb-3">
            ...
            <input type="radio" value="Male" <?php if ($r_user['gender'] == 'Male') echo 'checked';  ?> name="gender"> Masculino
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" value="Female" <?php if ($r_user['gender'] == 'Female') echo 'checked';  ?> name="gender"> Femenino
          </div>
