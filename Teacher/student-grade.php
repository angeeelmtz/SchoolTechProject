...
<head>
	...
	<title>Profesor - Estudiante</title>
        ...
        <form method="post"
            ...
            <div class="mb-3">
                <ul class="list-group">
                  ...
                  <li class="list-group-item"><b>Apellido: </b> <?php echo $student['lname'] ?></li>
                  <li class="list-group-item"><b>Gardo: </b> 
                  ...
                  <li class="list-group-item text-center"><b>Año: </b> <?php echo $setting['current_year']; ?> &nbsp;&nbsp;&nbsp;<b>Semeste</b> <?php echo $setting['current_semester']; ?></li>
                </ul>
            </div>
            <h5 class="text-center">Agregar calificación</h5>
