     ...
     <div class="container mt-5">
         <div class="card" style="width: 22rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Correo electrónico: <?=$student['email_address']?></li>
            ...
            <br><br>
            <li class="list-group-item">Nombre del acudiante: <?=$student['parent_fname']?></li>
            <li class="list-group-item">Apellido del acudiente: <?=$student['parent_lname']?></li>
            <li class="list-group-item">Teléfono del acudiente: <?=$student['parent_phone_number']?></li>
          </ul>
        </div>
     </div>
     <?php 
